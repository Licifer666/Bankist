...
btnClose.addEventListener('click', function(e){
    ...
    if(
        inputCloseUsername.value === currentAmount.username && 
...
// SLICE METHODS DOES NOT MUTATE ORIGINAL ARRAY ITS CREATE A COPY  OF THE ARRAY
...
// The new at Method
// const arr = [23, 11, 64];
// console.log(arr[0]);//Old school way to find the index value
// console.log(arr.at(-1));//New Method to find index value

// getting last array element using multiple ways
...
// Set 
// const currenciesUnique = new Set([ 'USD', 'INR', 'GBP', 'EUR', 'EUR']);
...
//2nd methods
// const movemeentUSD = movements.map(mov => mov * eurToUsd);

// console.log(movements);
// console.log(movemeentUSD);
...
//   console.log(`Humans age are : ${humanAges}`);
//   console.log(`Dogs ages are: ${adults}`);
...
// console.log(`First data output: ${avg1}\n`,`Second data outtput: ${avg2}`);
...
// // // PIPELINE
// const totalDepositesUSD = movements.filter(mov => mov > 0).map((mov, i, arr) =>{
//   //console.log(arr);
//   return mov * eurToUsd;
// })
//.map(mov => mov * eurToUsd)
// .reduce((acc, mov) => acc + mov, 0);
// console.log(Math.trunc(totalDepositesUSD));
...
//Strings
// const owners = ['Jonas', 'Zeck', 'Adam', 'Martha'];
